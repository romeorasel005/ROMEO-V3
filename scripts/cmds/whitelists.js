...
module.exports = {
	...
	langs: {
		vi: {
			...
			alreadyAdmin: "\n⚠️ | %1 người dùng đã có quyền whiteListIds từ trước rồi:\n%2",
			missingIdAdd: "⚠️ | Vui lòng nhập ID hoặc tag người dùng muốn thêm quyền whiteListIds",
			removed: "✅ | Đã xóa quyền whiteListIds của %1 người dùng:\n%2",
			notAdmin: "⚠️ | %1 người dùng không có quyền whiteListIds:\n%2",
			missingIdRemove: "⚠️ | Vui lòng nhập ID hoặc tag người dùng muốn xóa quyền whiteListIds",
